...
from milestone3tests import tests_cat, tests_wc, tests_ls_cd
from milestone4tests import tests_builtins_pipes
...
if __name__ == "__main__":
  ...
  # begin_testing(entire_class=False, student="perfectstudentM6DONOTSENDTOSTUDENTS")
